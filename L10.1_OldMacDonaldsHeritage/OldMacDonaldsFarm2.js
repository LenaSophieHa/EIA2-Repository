...
(function (L10_OldMacDonals) {
    ...
    document.addEventListener("DOMContentLoaded", () => {
        let farm = new L10_OldMacDonals.Farm(); // erstellung der Farm mit den Tieren
        let animals = [
            new L10_OldMacDonals.Cow("Cow", "Bessie", "Moo", ["Grass"], 150),
            new L10_OldMacDonals.Chicken("Chicken", "Clucky", "Cluck", ["Grains"], 50),
            new L10_OldMacDonals.Dog("Dog", "Rex", "Woof", ["Meat"], 100),
            new L10_OldMacDonals.Horse("Horse", "Spirit", "Neigh", ["Hay"], 200),
            new L10_OldMacDonals.Pig("Pig", "Porky", "Oink", ["Junk"], 120)
        ];
...
//# sourceMappingURL=OldMacDonaldsFarm2.js.map